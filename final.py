...
def delimeter(ref, fer):
    return ref - fer + sqrt(ref)
...
deli = delimeter(max(len(n), len(m)), min(len(n), len(m)))
...
print(str(abs(paces - deli)) + " paces away from threshold.")
